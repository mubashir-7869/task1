...
return [
     ...
     */
    'mail_to' => 'mubashrhussain@gmail.com',
    'mail_from' => 'mubashrhussain@gmail.com', // by default this is config('mail.from.address')
     ...
     */
    'classes' => [
        'container' => 'text-base items-end z-50 flex-col m-4 gap-3 fluid',
       ...
       'button' => 'inline-flex justify-center items-center px-4 py-3 h-10 border-0 bg-purple-500 hover:bg-purple-600 active:bg-purple-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
     ...
     */
    'form_action_route' => 'support_request.store',
